...
import { listInventoryContainers } from "../../logic/inventory-stock.logic";
...
export const InventoryContainerPage = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "lot_number", headerName: "Lot Number", width: 100 },
    {
      ...
      align: "right",
      width: 90,
      valueGetter: (params) => params.row.unit_cost.toFixed(2),
    },
    {
    ...
    { field: "sample", type: "boolean", headerName: "Sample?", width: 80 },
    {
      ...
      headerName: "Rec Qty",
      width: 120,
      valueGetter: (params) => params.row.received_amount.toFixed(5),
    },
    {
      field: "remaining_amount",
      headerName: "Rem Qty",
      width: 120,
      valueGetter: (params) => params.row.remaining_amount.toFixed(5),
    },
    {
      ...
      width: 120,
      valueGetter: (params) => params.row.allocated_amount.toFixed(5),
    },
    {
      field: "quarantined_containers",
      description: "Quarantined Containers",
      headerName: "Quar Conts",
      width: 100,
    },
    ...
    { field: "supplier_sku", headerName: "Sup SKU", width: 130 },
    {
      ...
      width: 100,
      valueGetter: (params) =>
        params.row.received_date ? params.row.received_date.split("T")[0] : "",
    },
    {
      field: "expiry_date",
      headerName: "Exp Date",
